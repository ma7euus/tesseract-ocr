...
CFLAGS = -g -O2
CPP = gcc -E
CPPFLAGS =  -I/usr/local/include/leptonica -I/usr/include/leptonica
CXX = g++
CXXCPP = g++ -E
...
EXEEXT = 
FGREP = /bin/grep -F
GENERIC_API_VERSION = 3.2
GENERIC_LIBRARY_NAME = tesseract
GENERIC_LIBRARY_VERSION = 3:2
GENERIC_MAJOR_VERSION = 3
GENERIC_RELEASE = 3.2
GENERIC_VERSION = 3.2.2
GREP = /bin/grep
...
PACKAGE_STRING = tesseract 3.02.02
PACKAGE_TARNAME = tesseract
PACKAGE_URL = 
PACKAGE_VERSION = 3.02.02
PACKAGE_YEAR = 2012
PATH_SEPARATOR = :
RANLIB = ranlib
SED = /bin/sed
...
STRIP = strip
VERSION = 3.02.02
abs_builddir = /home/mateus/tesseract-ocr
abs_srcdir = /home/mateus/tesseract-ocr
abs_top_builddir = /home/mateus/tesseract-ocr
abs_top_srcdir = /home/mateus/tesseract-ocr
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/mateus/tesseract-ocr/config/install-sh
...
#EXTRA_DIST = doc/html doc/tesseract_3.02.02.pdf doc/tesseract_3.02.02.ps.gz
...
doc-pack: doc
	-chmod a+r $(top_srcdir)/doc/html/*
	 @tar --create --directory=$(top_srcdir)/doc/html --verbose --file=- . | gzip -c -9 > $(top_srcdir)/tesseract-3.02.02-doc-html.tar.gz;
