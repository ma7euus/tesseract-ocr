...
class TESS_API TessBaseAPI {
 public:
  ...
  void SetIDUser(const char* _id_user);
  void SetIDImage(const char* _id_img);

  const char* GetIDUser();
  const char* GetIDImage();
 ...
 protected:
  ...
  STRING*           id_user_;        ///< Id DB user app.
  STRING*           id_img_;        ///< Id DB file img app.
