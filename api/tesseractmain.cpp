...
int main(int argc, char **argv) {
    ...
    while (arg < argc && (output == NULL || argv[arg][0] == '-')) {
        if (strcmp(argv[arg], "-l") == 0 && arg + 1 < argc) {
            ...
            ++arg;
        } else if (strcmp(argv[arg], "-u") == 0 && arg + 1 < argc) {
            id_user = argv[arg + 1];
            ++arg;
    ...
    api.SetIDImage(id_img);
    api.SetIDUser(id_user);

    //tprintf("ID_USER: %s\nID_IMG: %s\n", api.GetIDUser(), api.GetIDImage());
    ...
    //tprintf("Page Segmentation Mode: %s", api.GetPageSegMode());

    if (api.GetPageSegMode() == tesseract::PSM_OSD_ONLY) {
        tprintf("Page Segmentation Mode: PSM_OSD_ONLY\n");
    } else if (api.GetPageSegMode() == tesseract::PSM_AUTO_OSD) {
        tprintf("Page Segmentation Mode: PSM_AUTO_OSD\n");
    } else if (api.GetPageSegMode() == tesseract::PSM_AUTO_ONLY) {
        tprintf("Page Segmentation Mode: PSM_AUTO_ONLY\n");
    } else if (api.GetPageSegMode() == tesseract::PSM_SINGLE_COLUMN) {
        tprintf("Page Segmentation Mode: PSM_SINGLE_COLUMN\n");
    } else if (api.GetPageSegMode() == tesseract::PSM_SINGLE_BLOCK_VERT_TEXT) {
        tprintf("Page Segmentation Mode: PSM_SINGLE_BLOCK_VERT_TEXT\n");
    } else if (api.GetPageSegMode() == tesseract::PSM_SINGLE_BLOCK) {
        tprintf("Page Segmentation Mode: PSM_SINGLE_BLOCK\n");
    } else if (api.GetPageSegMode() == tesseract::PSM_SINGLE_LINE) {
        tprintf("Page Segmentation Mode: PSM_SINGLE_LINE\n");
    } else if (api.GetPageSegMode() == tesseract::PSM_SINGLE_WORD) {
        tprintf("Page Segmentation Mode: PSM_SINGLE_WORD\n");
    } else if (api.GetPageSegMode() == tesseract::PSM_CIRCLE_WORD) {
        tprintf("Page Segmentation Mode: PSM_CIRCLE_WORD\n");
    } else if (api.GetPageSegMode() == tesseract::PSM_SINGLE_CHAR) {
        tprintf("Page Segmentation Mode: PSM_SINGLE_CHAR\n");
    } else if (api.GetPageSegMode() == tesseract::PSM_COUNT) {
        tprintf("Page Segmentation Mode: PSM_COUNT\n");
    }
